<#
.SYNOPSIS
  Main script to export OIM CanSeeScripts from TagData XML files.

.DESCRIPTION
  Orchestrates the extraction of CanSeeScripts from OIM Transport XML files.
...
.EXAMPLE
  CanSeeScripts_Main_PsModule -ZipPath "C:\Input\tagdata.xml" -OutPath "C:\Output" -DMConfigDir "C:\Config" -DMDll "C:\DM.dll"
#>
