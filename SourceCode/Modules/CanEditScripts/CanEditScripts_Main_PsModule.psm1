<#
.SYNOPSIS
  Main script to export OIM CanEditScripts from TagData XML files.

.DESCRIPTION
  Orchestrates the extraction of CanEditScripts from OIM Transport XML files.
...
.EXAMPLE
  CanEditScripts_Main_PsModule -ZipPath "C:\Input\tagdata.xml" -OutPath "C:\Output" -DMConfigDir "C:\Config" -DMDll "C:\DM.dll"
#>
