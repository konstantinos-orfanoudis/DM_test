...
try {
  ...
  $config = InputValidator -DMConfigDir $DMConfigDir -OutPath $OutPath -LogPath $LogPath `
    -IncludeEmptyValues:$IncludeEmptyValues -PreviewXml:$PreviewXml -CSVMode:$CSVMode -DMDll $DMDll
