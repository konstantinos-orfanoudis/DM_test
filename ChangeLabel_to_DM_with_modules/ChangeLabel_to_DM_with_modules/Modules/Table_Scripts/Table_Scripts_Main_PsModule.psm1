...
function Table_Scripts_Main_PsModule{
param(
...
Import-Module (Join-Path $scriptDir "Table_Scripts_XmlParser.psm1") -Force
Import-Module (Join-Path $parent "PsModuleLogin.psm1") -Force
Import-Module (Join-Path $scriptDir "Table_Scripts_Exporter_PsModule.psm1") -Force
